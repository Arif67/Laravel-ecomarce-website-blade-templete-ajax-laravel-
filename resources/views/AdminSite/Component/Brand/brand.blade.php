...
<nav style=" margin-left:10px; margin-top:100px;" class="navbar navbar-light bg-light ">
  ...
  <h3> <a class="navbar-brand text-info"> BRAND</a></h3> 
    ...
    <tr>
      ...
      <td>
         <button type="button" class=" ms-5 me-5 btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal{{$item->id}}">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form method="POST"  action="{{ route('brand.update', ['id' => $item->id]) }}" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT')
                        <!-- Category Name input -->
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-block">Edit Brand</button>
                    </form>
          ...
          <form method="POST" action="{{ route('brand.destroy', ['id' => $item->id]) }}" style="display: inline;">
              @csrf
              @method('DELETE')
